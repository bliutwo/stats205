...
Based on the large p-values, there is *no evidence* that height or weight contribute significantly over each other to the determination of heart catheter length.
