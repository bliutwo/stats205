...
<!-- # qSpearman(0.01, r = 7) -->
```{r}
# this method of performing the test was given in the textbook, but may not be done correctly here - hence, I eventually end up performing the same function as on the slides
library(SuppDists)
