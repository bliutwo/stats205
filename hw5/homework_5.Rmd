...
There is *strong evidence* that, individually, height and weight contribute to the determination of heart catheter length.
```
...
However, based on the large p-values, there is *not enough evidence* to suggest that height or weight contribute significantly over each other to the determination of heart catheter length.