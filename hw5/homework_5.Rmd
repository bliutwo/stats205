...
Based on the large p-values, there is *not enough evidence* to suggest that height or weight contribute significantly over each other to the determination of heart catheter length.
...
However, there is *strong evidence* that height and weight individually contribute to the determination of heart catheter length.