...
wilcox.test(x = nonallergics, y = nonallergics, conf.int=TRUE, conf.level=.90)

wilcox.test(x = nonallergics, y = nonallergics, alternative = "less", conf.int=TRUE, conf.level=.90)
```
