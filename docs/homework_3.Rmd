...
x = c(67, 43)
n = c(101, 107)
prop.test(x, n, alternative = c("greater"), conf.level = 0.95)
```

The 95% confidence interval for difference between rate of tonsillectomy in Hodgkin's cases and rate of tonsillectomy in non-Hodgkin's cases is between 