...
```{r}
who_suicide_statistics_df <- read.csv("who_suicide_statistics.csv"); who_suicide_statistics_df
...
```{r}
filtered_suicide_df <- filter(who_suicide_statistics, "suicides_no" == "NA"); filtered_suicide_df
```
