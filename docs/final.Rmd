...
for (i in seq_along(list_of_continents))
{
	...
	cat("\n")
	countries_per_continent[[i]] <- filtered_suicide_df[filtered_suicide_df$continent == toString(list_of_continents[i]),]
	head(countries_per_continent[[i]])
	# continent <- filtered_suicide_df[filtered_suicide_df$continent == list_of_continents[i],]
	# head(continent)
}
