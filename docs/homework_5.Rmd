...
**NOTE**: At this point, I tried to use `cor.test()` with `method = "spearman"` but I got a different result, and I'm not sure why.

```{r}
cor.test(x = cysticerci, y = worms_reco, method = "spearman", alternative = "greater")
cor.test(x = cysticerci, y = worms_reco, method = "spearman")
```
