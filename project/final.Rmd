...
[This text links to very important information about why a `for` loop doesn't print anything.](https://stackoverflow.com/questions/14987743/head-function-does-not-work-within-for-loop) You will never again spend hours trying to find out why a `for` loop doesn't print anything because you're no longer an R newbie. 
