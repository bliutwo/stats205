...
# binom.confint(x = 56, n = 65, conf.level = 0.96, methods = c("wilson"))

# Laplace-Wald confidence interval

# Agresti-Coull
# binom.confint(x = 56, n = 65, conf.level = 0.96, methods = c("agresti-coull"))

# Clopper-Pearson
# binom.lrt(x = 56, n = 65, conf.level = 0.96, conf.adj = FALSE)
