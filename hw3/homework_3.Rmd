...
\[
    = P_{p = 0.7}(\frac{B - 67(0.6)}{(67(0.6)(0.4))^{\frac{1}{2}}} \geq 1.645)
\]
...
\[
    = P_{p=0.7}\bigg(\frac{B - 67(0.7)}{(67(0.7)(0.3))^{\frac{1}{2}}} \geq \frac{1.645(67(0.6)(0.4))^{\frac{1}{2}} + 67(0.6) + 67(0.7)}{(67(0.7)(0.3))^{\frac{1}{2}}})
\]
...
```{r}
library(pwr)
pwr.p.test(h = 0, n = 67, sig.level = 0.05, power = NULL, alternative = c("greater"))
```
