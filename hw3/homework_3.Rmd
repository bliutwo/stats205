...
prop.test(x = elisa_matrix)

mcnemar.test(x = elisa_matrix)
```

The $P$-value for McNemar's test is $0.1687$, while the $P$-value for the ordinary unpaired chi-squared test is . We can conclude that the hypothesis of equal proportions 